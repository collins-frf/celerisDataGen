...
line39=['				<colormap auto = false min = -1.25 max = 2.5></colormap>\n'];
line40=['			    <drylandDepthOfInundation auto = true show = False value = 0.1 max = 1></drylandDepthOfInundation>\n'];
...
line44=['			<terrainTexture type = 8><colormap auto = false min = -13.25 max = 7.68></colormap>\n'];
line45=['			</terrainTexture>\n'];
		
line46=['			<lighting ambient = .4  sunAltitude = 0 sunAzimuth = 84></lighting>\n'];
line47=['			<fresnel coef = 0 refractive_index = 3 attenuation_1 = 0 attenuation_2 = 0.29></fresnel>\n'];
line48=['			<camera auto = false FOV = 95 x = 0 y = 850 z = ' num2str(sqrt(m_width^2+m_length^2)/1.75) ' pitch = -89.5 yaw = 0></camera>\n'];
